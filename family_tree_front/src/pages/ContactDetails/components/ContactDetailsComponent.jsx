        ...
        <div className="wrapperForm">
            ...
            <form className='form' onSubmit={handleSubmit(onFormSubmitHandler)}>
                <div className="inputContainer">
                    <label htmlFor="login" className='label'>Фамилия</label>
                    <input type="text"
                           {...register("login")}
                           name="login"
                           className='input'
                ...
                <div className="inputContainer">
                    <label htmlFor="password" className='label'>Имя</label>
                    <input type="password"
                           {...register("password")}
                           name="password"
                           className='input'
                ...
                <div className="inputContainer">
                    <label htmlFor="password" className='label'>Отчество</label>
                    <input type="password"
                           {...register("password")}
                           name="password"
                           className='input'
